...
const getFilmCommentElements = (comments) => (
  ...
  <span class="film-details__comment-emoji">
    <img src="./images/emoji/${comment.emoji}" width="55" height="55" alt="emoji-${comment.alt}">
</span>
    <div>
...
export const createFilmInfoTemplate = (task) => {
  const { filmName, filmPoster, description, rate, releaseDateFull, time, filmGenresFull, director, writers, actors, country, ageRating, comments } = task;
  const correctGenres = filmGenresFull.length > 1 ? 'Genres' : 'Genre';
    ...
    <div class="film-details__top-container">
      ...
      <div class="film-details__bottom-container">
        <section class="film-details__comments-wrap">
          ...
          <ul class="film-details__comments-list">${getFilmCommentElements(comments)}</ul>
